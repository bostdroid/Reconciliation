...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>ATM Reconciliation Tool - Dashboard</title>
	...
	лёгкий, многофункциональный и простой в использовании шаблон для админки на bootstrap 3.3.6. Загрузить исходники с <a href="https://github.com/bopoda/ace">github</a> (with minified ace js/css files).
								...
								<div class="row">
									...
									<div class="vspace-12-sm"></div>
                                                                        <div>Total Transactions ${transactionSize}</div>
                                                                        <div>Total Dispense Error Transactions ${dispenseErrorSize}</div>
                                                                        <div>Total Successful Transactions ${successSize}</div>
                                                                        <div>Total Failed Transactions ${failedSize}</div>
			...
			jQuery(function($) {
			  ...
			  var placeholder = $('#piechart-placeholder').css({'width':'90%' , 'min-height':'150px'});
                    ...
                    <s:iterator value="disperror">   
                        ...
                        {label: "Terminal", data: '<s:property value="terminal"/>',color: "#2091CF",
                        label: "Count", data: '<s:property value="display"/>', color: "#DA5430"
                         },
                    </s:iterator>
                        <%--<s:iterator value="disperror">--%>
//                            {label: "Terminal", data: '
