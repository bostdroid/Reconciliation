                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Journal Viewer</li>
                        </ul><!-- /.breadcrumb -->
                    ...
                    <div class="page-content">
                        ...
                        <div class="widget-box">
                            <div class="widget-header widget-header-blue widget-header-flat">
                                <h4 class="widget-title lighter">Select Journal to Download</h4>
                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <div id="fuelux-wizard-container">
                                        <div>
                                            <ul class="steps">
                                                <li data-step="1" class="active">
                                                    ...
                                                    <span class="title">Input Terminal ID</span>
                                                </li>
                                        ...
                                        <hr />
                                        <s:form action="invent" id="myForm" method="post">
                                        <div class="step-content pos-rel">
                                            
                                            <div class="step-pane active" data-step="1">
                                                
                                                <h3 class="lighter block green">Enter the Terminal ID</h3>
                                                
                                                    <div class="col-md-4 col-md-offset-4">
                                                    <input type="text" id="terminalID" name="terminalID" required="required" placeholder="Terminal ID" size="45"/>
                                            ...
                                            <div class="step-pane" data-step="2">
                                                ...
                                                <h3 class="lighter block green">Select Date</h3>
                                                <div class="col-md-4 col-md-offset-4">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-8 col-sm-11">
                                                            <div class="input-group">
                                                                ...
                                                                <input class="form-control date-picker" id="inputField" value="${file.journalDate}" type="text" data-date-format="yyyy-mm-dd" name="journalDate"/>
            ...
            jQuery(function($) {
                ...
                //})
                        .on('finished.fu.wizard', function(e) {
                            if (document.getElementById('datePicker').value !=="" && document.getElementById('terminalID').value!=="") {
                                document.getElementById('myForm').submit(); 
                    }
                            else
                    {
                        alert("Please specify the Journal Date and the Terminal ID.");
                    }
...
//        else if (document.getElementById('terminalID').value == "ALL" && document.getElementById('datePicker').value != ""){
//            document.getElementById('myForm').action="findAllJournalViewer";
//            document.getElementById('myForm').submit();
//        }
        else
        {
                ...
                <div class="navbar-collapse collapse templatemo-sidebar">
                   <ul class="templatemo-sidebar-menu">
                            <!--li class="dropdown">
                                ...
                                <li class="active"><a href="initFile" style="font-size: 14px;font-family: Calibri; font-weight: bolder;"><i class="fa fa-download text-orange"></i> Download</a></li>
                                ...
                                <li><a href="initReport" style="font-size: 14px;font-family: Calibri; font-weight: bolder;"><i class="fa fa-android text-orange"></i>Dashboard</a></li>
                                 </ul>
                ...
                <div class="templatemo-content-wrapper">
                    <div class="templatemo-content">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="#">File Download</a></li>
                        </ol>
    ...
    <s:form action="invent" method="post" id="theForm">
                        ...
                        <div class="col-sm-11">
                            ...
                            <div class="col-xs-3"> 
                                <span style="font-family: calibri; font-size: 12px;
                                      font-weight: bolder; color:#0059b3;"> 
                                    Journal Date<br></span><input type="text" name="journalDate" required="required" value="${file.journalDate}" 
                                          style="font-family: calibri; font-size: 15px;" id="inputField" placeholder="Click to select date"/>
                            </div>
                            <ol class="breadcrumb">
                            <div class="row">
                        <div class="col-sm-3" >
...
<script type="text/javascript">
        $(function () {
            ...
            $("#inputField").ejDatePicker({

                dateFormat: "yyyy-MM-dd" // sets the date format to display in input.
