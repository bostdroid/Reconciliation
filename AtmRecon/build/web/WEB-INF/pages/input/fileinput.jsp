                                            ...
                                            <div>
                                                <ul class="steps">
                                                    ...
                                                    <li data-step="2">
                                                        ...
                                                        <span class="title">Download Date</span>
                                                    </li>
                                                    <!--  <li data-step="3">
                                                ...
                                                <div class="step-content pos-rel">
                                                    <div class="step-pane active" data-step="1">
                                                        ...
                                                        <div class="col-md-4 col-md-offset-4">
                                                            <input type="text" id="terminalID" name="terminalID" required="required" placeholder="Terminal ID" size="16"/>
                                                        </div>
                                                    </div>
